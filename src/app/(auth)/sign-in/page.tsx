...
const Page = () => {
    ...
    const origin = searchParams.get('origin')//will be used in redirecting(cart to sign-in)
  ...
  const {
    ...
    resolver: zodResolver(AuthCredentialsValidator),//except a schema for validation
  })

  

    //creating a procedure for sign up ki user apne credintials shai daale fir ye krna hai
